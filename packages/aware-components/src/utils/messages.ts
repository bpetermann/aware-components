export const messages = {
  ...
  ul: {
    children:
      '[Ul] Lists should only contain <li> elements as direct children. Using other elements violates HTML semantics and can impact accessibility. Affected element: ',
    role: '[Ul] Consider using a native <li> element instead of an element with role="listitem". While using role="listitem" is valid, it sacrifices semantic richness, making it harder for assistive technologies to fully understand the content. Native HTML elements provide better accessibility and should be preferred when possible. Affected element: ',
  },
  ol: {
    children:
      '[Ol] Lists should only contain <li> elements as direct children. Using other elements violates HTML semantics and can impact accessibility. Affected element: ',
    role: '[Ol] Consider using a native <li> element instead of an element with role="listitem". While using role="listitem" is valid, it sacrifices semantic richness, making it harder for assistive technologies to fully understand the content. Native HTML elements provide better accessibility and should be preferred when possible. Affected element: ',
  },
} as const;
